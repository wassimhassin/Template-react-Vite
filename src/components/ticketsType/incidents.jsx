...
const Incidents = () => {
  ...
  // Filtrer uniquement les incidents non fermés
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col no-scrollbar">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm mt-1">Gestion et suivi des incidents ouverts et en cours</p>
              </div>
            </div>
      ...
      {/* Tableau des incidents + Pagination */}
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {paginatedTickets.map((ticket) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className={`px-2 py-1 text-xs font-semibold rounded-full bg-red-100 text-red-800`}>{ticket.type}</span>
                      </td>
