  ...
  useEffect(() => {
    let filtered = tickets.filter(ticket => {
      return (
        ...
        (filters.appelant === '' || ticket.appelant === filters.appelant) &&
        ...
        (filters.statut === '' || ticket.statut === filters.statut) &&
            ...
            <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                ...
                <div>
                  ...
                  <select
                    value={filters.appelant}
                    onChange={(e) => handleFilterChange('appelant', e.target.value)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                  >
                    <option value="">Tous</option>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-2 sm:gap-4">
              ...
              <div className="flex items-center space-x-3 p-3 bg-green-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold text-gray-900">{filteredTickets.filter(t => t.statut === 'Closed').length}</p>
                </div>
              </div>
            </div>
          </div>
