      ...
      <div className="w-full bg-gray-100 lg:w-1/2 flex items-center justify-center">
        <div className="max-w-md w-full p-6">
          ...
          <div className="mt-4 text-sm text-gray-600 text-center">
            <p>Connexion par identifiants</p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`mt-1 p-2 w-full border rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300 ${errors.username && touched.username ? 'border-red-500 ring-red-200' : 'border-gray-300'}`}
                  value={form.username}
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`mt-1 p-2 w-full border rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300 ${errors.password && touched.password ? 'border-red-500 ring-red-200' : 'border-gray-300'}`}
                  value={form.password}
                  onChange={handleChange}
                  onBlur={handleBlur}
